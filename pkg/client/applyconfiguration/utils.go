...
func ForKind(kind schema.GroupVersionKind) interface{} {
	...
	case v1alpha1.SchemeGroupVersion.WithKind("Task"):
		return &taskv1alpha1.TaskApplyConfiguration{}
	case v1alpha1.SchemeGroupVersion.WithKind("TaskSpec"):
		return &taskv1alpha1.TaskSpecApplyConfiguration{}
	case v1alpha1.SchemeGroupVersion.WithKind("TaskStep"):
		return &taskv1alpha1.TaskStepApplyConfiguration{}
