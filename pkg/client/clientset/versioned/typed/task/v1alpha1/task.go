...
import (
	...
	scheme "github.com/shenyisyn/myci/pkg/client/clientset/versioned/scheme"
...
type TaskInterface interface {
	...
	Apply(ctx context.Context, task *taskv1alpha1.TaskApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Task, err error)
	TaskExpansion
}
...
func (c *tasks) Apply(ctx context.Context, task *taskv1alpha1.TaskApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Task, err error) {
	if task == nil {
