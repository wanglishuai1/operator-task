...
type TaskSpecApplyConfiguration struct {
	Steps []TaskStepApplyConfiguration `json:"steps,omitempty"`
}
...
func (b *TaskSpecApplyConfiguration) WithSteps(values ...*TaskStepApplyConfiguration) *TaskSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
